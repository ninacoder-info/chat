...
namespace NiNaCoder\Chat\Tests;
...
use NiNaCoder\Chat\ChatServiceProvider;
use NiNaCoder\Chat\Facades\ChatFacade;
use NiNaCoder\Chat\Tests\Helpers\Models\User;
...
//         ]);
        ...
        $app['config']->set('chat.user_model', 'NiNaCoder\Chat\Tests\Helpers\Models\User');
        $app['config']->set('chat.sent_message_event', 'NiNaCoder\Chat\Eventing\MessageWasSent');
